...
var require_dist_node6 = __commonJS((exports2) => {
  ...
  function graphql2(request2, query2, options) {
    if (typeof query2 === 'string' && options && 'query' in options) {
      return Promise.reject(new Error(`[@octokit/graphql] "query" cannot be used as variable name`));
    }
    const parsedOptions =
      typeof query2 === 'string'
        ? Object.assign(
            {
              query: query2,
            },
...
var import_graphql = __toModule(require_dist_node6());
...
var getAllIdentities = async ({ query: query2, client, after }) => {
  ...
  if (hasNextPage) {
    ...
    const paginatedIdentities = await getAllIdentities({ client, query: query2, after: cursor });
...
(function (Props2) {
  ...
  Props2['organization'] = 'organization';
  Props2['username'] = 'username';
})(Props || (Props = {}));
var getParams = () => {
  return Object.keys(Props).reduce((memo, prop) => {
    const value = import_core.getInput(prop);
